...
class MuMuKeepAliveService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (nm.areNotificationsEnabled() && canPostNotificationsCompat()) {
            try {
                nm.notify(Constants.Notifications.KEEPALIVE_NOTIFICATION_ID, notification)
    ...
    private fun canPostNotificationsCompat(): Boolean {

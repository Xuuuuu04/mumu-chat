...
class NotificationCenter(
    ...
    fun showReminder(id: String, title: String, text: String?) {
        if (!canPostNotifications()) return
        ensureChannel()
        val builder = NotificationCompat.Builder(context, Constants.Notifications.CHANNEL_REMINDER)
            .setSmallIcon(R.drawable.ic_stat_mumuchat)
            .setColor(ContextCompat.getColor(context, R.color.brand_accent))
            .setContentTitle(title)
    ...
    private fun ensureChannel() {
        ...
        if (manager.getNotificationChannel(Constants.Notifications.CHANNEL_STATUS) == null) {
        ...
        if (manager.getNotificationChannel(Constants.Notifications.CHANNEL_REMINDER) == null) {
            manager.createNotificationChannel(
                NotificationChannel(
                    Constants.Notifications.CHANNEL_REMINDER,
                    "提醒通知",
